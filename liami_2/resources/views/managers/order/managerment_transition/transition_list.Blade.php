        ...
        <div class="main-content-wrap">
            <div class="flex items-center flex-wrap justify-between gap20 mb-27">
                ...
                <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                    ...
                    <li>
                        <div class="text-tiny">Transition List</div>
                    </li>
                </ul>
            </div>
            <!-- order-list -->
            <div class="wg-box">
                ...
                <div class="wg-table table-all-category">
                    <ul class="table-title flex gap20 mb-14">
                        ...
                        <li>
                            <div class="body-title">Transition ID</div>
                        </li>
                        <li>
                            <div class="body-title">Customer</div>
                        </li>
                        <li>
                            <div class="body-title">Date order</div>
                        </li>
                        <li>
                            <div class="body-title">Payment Status</div>
                        </li>
                        <li>
                            <div class="body-title">COD status</div>
                        </li>
                    ...
                    <ul class="flex flex-column">
                        <li class="product-item gap14">
                            ...
                            <div class="flex items-center justify-between gap20 flex-grow">
                                ...
                                <div>
                                    <div class="block-tracking">Đã thu hộ</div>
                                </div>
