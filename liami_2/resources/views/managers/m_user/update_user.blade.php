                            ...
                            <form action="{{ route('managers.m_user.update_user_action', $user->UserID) }}" method="POST">
                                ...
                                <div class="wg-box">
                                    ...
                                    <fieldset>
                                        ...
                                        <input class="mb-10" type="password" name="Current_Password" placeholder="Enter current password" required>
                                        <div class="text-tiny">You need to enter your current password to update.</div>
                                    </fieldset>
                                    <fieldset>
                                        ...
                                        <div class="text-tiny">Leave blank to keep the new password.</div>
                                    </fieldset>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="text-tiny">Please confirm your new password.</div>
                                    </fieldset>
