(function (a) {
    ...
    a.JQPlugin.createPlugin({
                ...
                if (m.options.serverSync) {
                    ...
                    if (o[2] == null) {
                        var n = a.isFunction(m.options.serverSync)
                            ...
                            : null;
                        o[2] =
                            (n ? new Date().getTime() - n.getTime() : 0) - o[1];
                    }
                    if (m._since) {
                        m._since.setMilliseconds(
                            m._since.getMilliseconds() + o[2]
                        );
                    }
        ...
        _updateCountdown: function (j, l) {
            ...
            j.html(this._generateHTML(l)).toggleClass(
                this._rtlClass,
                l.options.isRTL
            );
        ...
        _adjustSettings: function (j, l, n) {
            ...
            if (n || (!n && l._until == null && l._since == null)) {
                ...
                if (l._since != null) {
                    l._since = this.UTCDate(
                        r,
                        this._determineTime(l._since, null)
                    );
                    if (l._since && p) {
                        l._since.setMilliseconds(
                            l._since.getMilliseconds() + p
                        );
                    }
                }
                l._until = this.UTCDate(
                    r,
                    this._determineTime(l.options.until, m)
                );
                if (p) {
        ...
        _calculatePeriods: function (m, y, z, u) {
            ...
            if (y[i] || y[e]) {
                ...
                var x =
                    A.getDate() == u.getDate() ||
                    (A.getDate() >= Math.min(o, q) &&
                        u.getDate() >= Math.min(o, q));
                var l = function (C) {
                    return (
                        (C.getHours() * 60 + C.getMinutes()) * 60 +
                        C.getSeconds()
                    );
                };
                var s = Math.max(
                    ...
                    (A.getFullYear() - u.getFullYear()) * 12 +
                        A.getMonth() -
                        u.getMonth() +
                        ((A.getDate() < u.getDate() && !x) || (x && l(A) < l(u))
                            ? -1
                            : 0)
                );
