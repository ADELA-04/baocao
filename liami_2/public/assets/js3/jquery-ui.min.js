...
(function (e) {
    ...
    e(document).mouseup(function () {
        ...
        e.widget("ui.menu", {
            ...
            _create: function () {
                (this.activeJewelleryu = this.element),
                    (this.mouseHandled = !1),
                    this.element
                        .uniqueId()
                ...
                switch (t.keyCode) {
                    ...
                    default:
                        (o = !1),
                            ...
                            n === s ? (a = !0) : (n = s + n),
                            (i = this._filterJewelleryuItems(n)),
                            (i =
            ...
            focus: function (e, t) {
                ...
                this.blur(e, e && "focus" === e.type),
                    ...
                    (this.activeJewelleryu = t.parent()),
            ...
            _scrollIntoView: function (t) {
                ...
                this._hasScroll() &&
                    ((i =
                        parseFloat(
                            e.css(this.activeJewelleryu[0], "borderTopWidth")
                        ) || 0),
                    (s =
                        parseFloat(
                            e.css(this.activeJewelleryu[0], "paddingTop")
                        ) || 0),
                    (n =
                        t.offset().top -
                        this.activeJewelleryu.offset().top -
                        i -
                        s),
                    (a = this.activeJewelleryu.scrollTop()),
                    (o = this.activeJewelleryu.height()),
                    (r = t.outerHeight()),
                    0 > n
                        ? this.activeJewelleryu.scrollTop(a + n)
                        : n + r > o &&
                          this.activeJewelleryu.scrollTop(a + n - o + r));
            },
            blur: function (e, t) {
            ...
            _filterJewelleryuItems: function (t) {
                var i = t.replace(/[\-\[\]{}()*+?.,\\\^$|#\s]/g, "\\$&"),
                    s = RegExp("^" + i, "i");
                return this.activeJewelleryu
                    .find(this.options.items)
                    .filter(".ui-menu-item")
                    .filter(function () {
        ...
        e.widget("ui.autocomplete", {
                ...
                (this.isMultiLine = a
                    ...
                    this._on(this.menu.element, {
                        ...
                        menufocus: function (t, i) {
                            var s, n;
                            return this.isNewJewelleryu &&
                                ((this.isNewJewelleryu = !1),
                                t.originalEvent &&
            ...
            _suggest: function (t) {
                ...
                this._renderJewelleryu(i, t),
                    (this.isNewJewelleryu = !0),
                    this.menu.refresh(),
                    i.show(),
                    this._resizeJewelleryu(),
                    i.position(
                        e.extend({ of: this.element }, this.options.position)
                    ),
                    this.options.autoFocus && this.menu.next();
            },
            _resizeJewelleryu: function () {
            ...
            _renderJewelleryu: function (t, i) {
                var s = this;
    ...
    e.extend(n.prototype, {
        ...
        e.widget("ui.selectmenu", {
            ...
            _drawButton: function () {
                ...
                (this.label = e("label[for='" + this.ids.element + "']").attr(
                    ...
                    this.button.one("focusin", function () {
                        t.menuItems || t._refreshJewelleryu();
                    }),
                    this._hoverable(this.button),
                    this._focusable(this.button);
            },
            _drawJewelleryu: function () {
                var t = this;
                (this.menu = e("<ul>", {
                    "aria-hidden": "true",
            ...
            _refreshJewelleryu: function () {
                this.menu.empty();
                var e,
                    t = this.element.find("option");
                t.length &&
                    (this._parseOptions(t),
                    this._renderJewelleryu(this.menu, this.items),
