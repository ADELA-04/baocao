            ...
            <div class="container">
                <div class="logo-menu-inner d-flex flex-wrap align-items-center justify-content-between w-100">
                    ...
                    <div class="logo-menu-inner-mid">
                        <nav>
                            <ul>
                                <li class="megamenu-item"><a href="{{ asset('') }}" title="">Home</a></li>
                                ...
                                <li class=""><a href="{{ route('blogs') }}" title="">Blogs</a>

                                </li>
                                <li class=""><a href="{{ route('contacts') }}" title="">Contact</a>
                ...
                <div class="logo-menu-inner-right d-flex flex-wrap align-items-center justify-content-end">
                    <nav>
                        <ul>
                            ...
                            <li class=" megamenu-item"><a href="{{ route('contacts') }}" title="">Contact</a>
